...
// скрипт для прилипаящей при ховере полоски ==============================================

document.addEventListener('DOMContentLoaded', () => {
   const menuLine = document.querySelector('.menu__line'),
      menuItem = document.querySelectorAll('.menu__lin');
...
// скрипт для добавления классов в помощь анимации при скроле (реализация всплывающих блоков) ================================================
   ...
   function animOnScroll() {
      for (let index = 0; index < animItems.length; index++) {
         ...
         if ((pageXOffset > animItemOffset - animItemPoint) && pageYOffset < (animItemOffset + animItemHeight)) {
            ...
            if (!animItem.classList.contains('_anim-no-hide')) { // чтоб анимация срабатывала только один раз
...
// при клике на картинку перенос её в другой блок (смена src адресов). Рабочий скрипт для этого случая находится в sliders.js ========================================================================================================================================================
/*
$(".sec35__small-filter").click(function () {

   var vega2 = $(this).attr('datai');
   $(".img35__big").attr('src', vega2);
   var descr = $('.sec35__small-text').text();
   console.log(descr);

});

*/
// Вывод текста в блоке при клике а другой блок ========================================================================================================================================================

$(document).ready(function () {
   $('.sec35__small-pic').on('click', function () {
      $('.sec35__descript').html($(this).find('.sec35__small-text').html());
      $('.sec35__descript').fadeIn(5000);
   })
});

//========================================================================================================================================================

let arrowTitle = document.querySelector('.sec35__title');
let imageBox = document.querySelector('.sec35__img-box');
arrowTitle.addEventListener("click", function (e) {
   arrowTitle.classList.toggle('_active');
   _slideToggle(imageBox);
});

/*
$(".sec35__title").on('click', function () {
   $('.sec35__img-box').toggle('_active');
}
*/
/*
// read-more ===========================================================
...
function scroll_scroll() {
	...
	if (header !== null) {
		if (src_value > 10) {//когда появится блок (хедер)
...
function _goto(target_block, speed, offset = 0) {//тут параметры для скролла (ofset - отступ сверху при фикс шапке)
	let header = '';
	//OffsetHeader
...
if (sliders) {
	...
	$(".img35__small-pic").click(function () {

		var vega2 = $(this).attr('src');
		console.log(vega2);
		// var sss = $(".opo")
		// sss.attr("srca")
		$(".img35__big").attr('src', vega2);
		$('.sec35__descript').html($(this).find('.sec35__small-text').html());
		$('.img35__big').fadeOut(100);
		$('.img35__big').fadeIn(400);
...
let slider_about = new Swiper('.right-block__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let projectSlider = new Swiper('.project-slider__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let cool = new Swiper('.slider-one__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let cool2 = new Swiper('.slider-one__body2', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let cool3 = new Swiper('.slider-one__body3', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let slider_about22 = new Swiper('.about-slier__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.about-slier__arrow-right',
		prevEl: '.about-slier__arrow-left',
	},
...
let slider_about35 = new Swiper('.sec35__small-body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.sec35__small-sliderArrow',
		prevEl: '.about-slier__arrow-left',
	},
...
// ниже подключение модалок Дена (если не нужны - удали)
/**
